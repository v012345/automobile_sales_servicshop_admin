<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="核销开始时间" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.allow_to_use_at }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="报名截止时间" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.end_at }}</span>
        </template>
      </el-table-column>
      <el-table-column label="优惠券失效时间" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.expire_at }}</span>
        </template>
      </el-table-column>
      <el-table-column label="关注人数" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.participants_count }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="主办方电话" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.tel }}</span>
        </template>
      </el-table-column>

<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.coupon" placeholder="是否有券" clearable style="width: 200px" class="filter-item">
        <el-option v-for="item in couponOptions" :key="item.key" :label="item.display_name" :value="item.key" />
      </el-select>
      <!-- <el-select
      ...
      <el-button v-waves :loading="downloadLoading" class="filter-item" type="primary" icon="el-icon-download"
        @click="handleDownloadAll">导出全部</el-button>
      <!-- <el-checkbox

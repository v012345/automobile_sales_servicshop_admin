<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="1级返利(团长返利)" align="center">
        <template slot-scope="{ row }">{{ row.level1 }}</template>
      </el-table-column>
      <el-table-column label="2级返利" align="center">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label-width="auto" label="1级返利" prop="level1">
          <el-input v-model.trim="temp.level1" />
        </el-form-item>
        <el-form-item label-width="auto" label="2级返利" prop="level2">
